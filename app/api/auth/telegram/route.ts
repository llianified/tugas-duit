...
import { transaction } from '@/server/platform/db'
import { assertSameOrigin, apiError, clientIp, handleRouteError, rateLimited, readJsonBody } from '@/server/platform/http'
import { checkRateLimit } from '@/server/platform/ratelimit'
import { createSession } from '@/server/auth/session'
import { claimInitData, verifyInitData } from '@/server/integrations/telegram'
import { bindUpline, generateReferralCode } from '@/server/economy/referral'
