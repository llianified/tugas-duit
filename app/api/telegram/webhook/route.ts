...
function startMessage(firstName: string | null) {
  ...
  return [
    ...
    'Cara mainnya simpel banget: pecahin soal singkat, kumpulin TD, tukar jadi Rupiah. Nggak ada modal, nggak ada drama.',
    '',
...
const HELP_MESSAGE = [
  ...
  '2. Makin cepat jawabnya, makin gede bintangnya, makin gede TD-nya.',
  '3. Tiap soal motong 1 energi. Energi ngisi sendiri, nggak perlu ditungguin.',
  '4. Bayaran tiap soal diambil dari stok reward kamu. Stoknya juga ngisi sendiri, dan makin gede kalau rank sama streak kamu naik.',
