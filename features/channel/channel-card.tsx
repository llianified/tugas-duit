...
/** Kartu ini tidak lagi menjaga dirinya sendiri: syarat "bonusnya masih ada" hidup di `channelBonusReachable`, dipanggil oleh `HomeView` yang juga memakai jawabannya untuk memutuskan jarak antar kartu. Kartu yang mengembalikan `null` sendiri berarti aturan yang sama tertulis di dua lapisan, dan lapisan yang di atas yang menyisakan jaraknya. Bentuknya kupon dengan stub yang disobek (lihat `.bonus-coupon` di globals.css). Alasannya bukan selera: ini satu-satunya kartu di beranda yang bisa HILANG kalau diabaikan, dan sebagai pelat rata ia terbaca sederajat dengan daftar transaksi yang tidak ke mana-mana. Kupon punya arah — ada yang disobek, dan sobekannya sekali. Isinya dirapatkan jadi tiga baris: nominal (dengan syarat "sekali seumur akun" ikut di baris yang sama sebagai keterangan, bukan kalimat sendiri), satu kalimat cair, lalu tombolnya. Versi sebelumnya memisah keduanya jadi dua paragraf, dan di layar 384px itu satu baris tinggi yang tidak menambah satu pun informasi baru. */
