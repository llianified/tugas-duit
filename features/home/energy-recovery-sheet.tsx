...
import { GlyphChevron, GlyphCrown, GlyphPlay, GlyphTrophy } from '@/shared/components/glyph'
...
export function EnergyRecoverySheet({
  ...
  return (
    <AppDialog open={open} onOpenChange={onOpenChange} title="Lanjut tanpa nunggu">
      <AppDialogBody>
        <Surface>
