...
const VARIANT_CLASS: Record<ActionButtonVariant, string> = {
  primary: [
    'control-h w-full bg-primary text-primary-foreground font-bold',
  ...
  quiet: [
    'control-h w-auto px-3 text-primary font-bold',
    'hover:text-primary-hover',
    'active:text-primary-active',
    'disabled:text-muted-foreground disabled:opacity-70',
  ].join(' '),
  ghost: [
    'control-h w-full text-muted-foreground font-semibold',
