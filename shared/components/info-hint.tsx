    ...
    <>
      ...
      {open ? (
        <span
          ...
          id={bubbleId}
          role="note"
          className="animate-hint-in pointer-events-none absolute inset-x-0 top-full z-30 mt-3 block rounded-bubble bg-muted bubble-p text-left text-[13px] font-normal leading-relaxed tracking-normal text-muted-foreground text-pretty"
        >
          <span
            ref={tailRef}
            aria-hidden="true"
